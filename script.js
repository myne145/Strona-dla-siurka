...
const setReviewTextBasedOnSelectedGame = () => {
    ...
    switch(gameURLName) {
        case 'mc_1.20':
            gameName = 'Minecraft Update 1.19';
            document.getElementById('reviewText').innerHTML = '<strong>W obliczu wydania wersji 1.19 Minecrafta fani ponownie zabrali głos. Krytyka The Wild Update nie skupia się na samej zawartości; pod ostrzałem jest komunikacja z deweloperami.</strong>\n' +
                '            <br>\n' +
                '            <br>\n' +
                '            <br>\n' +
                '            <br>\n' +
        ...
        case 'tloup1':
            ...
            document.getElementById('reviewText').innerHTML = '<strong>The Last of Us Part I</strong> to zdecydowanie jedna z najlepszych, najbardziej wciągających i najlepiej dopracowanych gier w historii naszej branży. Oczywiście, gdy mamy na myśli wersję konsolową. Pierwotnie wydana w 2013 roku na PlayStation 3, doczekała się solidnego remake\'u na PS5, by po kilku miesiącach wylądować na PC. W niniejszym tekście skoncentruję się wyłącznie na aspektach technicznych, pokazując jak działa i co oferuje wersja przeznaczona na "blaszaki". Ocena, którą znajdziecie na samym dole, dotyczy wyłącznie jakości konwersji i nie odnosi się w żaden sposób do rozgrywki, fabuły, klimatu i ogólnej oceny samej gry.\n' +
                ...
                '       ';
            document.getElementById('gameImage').src = 'tlou1.jpg';
            break;
        case 'hogwartslegacy':
            gameName = 'Hogwarts Legacy';
            document.getElementById('reviewText').innerHTML = '<strong>\n' +
                ...
                '       ';
            document.getElementById('gameImage').src = 'hogwartslegacy.jpg';
            break;
    }
...
const displayLoggedInAccountOnPageLoad = () => {
    ...
    if (password === null || username === null || password === undefined || username === undefined) {
        ...
        document.getElementById('headerContacts').setAttribute('onclick', `contacts.html?username=${username}&password=${password}`);
        document.getElementById('game1').setAttribute('href', `reviewpage.html?data=mc_1.201&username=${username}&password=${password}`);
        document.getElementById('game2').setAttribute('href', `reviewpage.html?data=tloup1&username=${username}&password=${password}`);
        document.getElementById('game3').setAttribute('href', `reviewpage.html?data=hogwartslegacy&username=${username}&password=${password}`);
    }
